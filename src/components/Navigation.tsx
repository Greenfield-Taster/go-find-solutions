        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="md:hidden">
            <button
              ...
              className="w-10 h-10 flex items-center justify-center text-white hover:text-neon-blue transition-colors duration-300"
            >
              {isOpen ? (
                <X className="w-6 h-6" />
              ) : (
            ...
            <div className="space-y-4">
              {navItems.map((item) => (
                <a
                  ...
                  className="block text-white/80 hover:text-neon-blue font-medium transition-colors duration-300 py-2"
                >
                  {item.name}
                </a>
              ))}
